...
const wStatic = { type: 'sprite', assetKey: 'w', sizeRatios: { width: 1, height: 1 } };

const wSizeRatios = { width: SPINE_SYMBOL_SIZE, height: SPINE_SYMBOL_SIZE };
const sSizeRatios = { width: SPINE_SYMBOL_SIZE, height: SPINE_SYMBOL_SIZE };
