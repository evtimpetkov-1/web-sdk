export default {
	...
	bigwin: {
		type: 'spine',
		src: {
			atlas: new URL('../../assets/spines/bigwin/kraken_win_4_1.atlas', import.meta.url).href,
			skeleton: new URL('../../assets/spines/bigwin/kraken_win_4_1.json', import.meta.url).href,
			scale: 1,
		},
	},
	shower: {
