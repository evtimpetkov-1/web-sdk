export default {
	...
	'Kraken\'s Wilds is a 5-reel, 3-row video slot with 20 fixed __0__. Wins are evaluated from left to right on each __1__, starting from the leftmost reel. Only symbols on adjacent reels count. The highest win per __1__ is __2__.': 'Kraken\'s Wilds adalah slot video 5-gulungan, 3-baris dengan 20 garis pembayaran tetap. Kemenangan dievaluasi dari kiri ke kanan pada setiap garis pembayaran, dimulai dari gulungan paling kiri. Hanya simbol pada gulungan yang berdekatan yang dihitung. Kemenangan tertinggi per garis pembayaran adalah dibayar.',
	'Base game: RTP 96.50%. Maximum win: 5,000x total __0__.': 'Permainan dasar: RTP 96,50%. Kemenangan maksimum: 5.000x total taruhan.',
	...
	'The Wild (Kraken) substitutes for all symbols except the Bonus symbol. Wild has its own __0__ values.': 'Wild (Kraken) menggantikan semua simbol kecuali simbol Bonus. Wild memiliki nilai pembayaran sendiri.',
	...
	'Bonus symbols __0__ in any position (not limited to __1__).': 'Simbol Bonus pembayaran di posisi mana pun (tidak terbatas pada garis pembayaran).',
	// GameRules — UI guide
