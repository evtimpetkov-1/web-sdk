export default {
	...
	// LoadingScreen
	'KRAKEN SPIN': 'KRAKOS-DREHUNG',
	'Land 3, 4 or 5 Bonus symbols anywhere on the reels to win 6, 12 or 18 Free Spins. Every Free Spin is a Kraken Spin.': 'Lande 3, 4 oder 5 Bonus-Symbole irgendwo auf den Walzen und gewinne 6, 12 oder 18 Freispiele. Jedes Freispiel ist eine Krakos-Drehung.',
	'The Kraken can strike any spin, adding Wilds, Coins or extra paying symbols to the reels.': 'Der Krakos kann bei jedem Spin zuschlagen und Wilds, Münzen oder zusätzliche Gewinnsymbole auf die Walzen setzen.',
	// PayTable — headers
	...
	'Substitutes for all symbols except Bonus and Coin. A Wild Kraken Spin adds 1 to 10 Wild symbols to the reels.': 'Ersetzt alle Symbole außer Bonus und Münze. Bei einer Krakos-Drehung vom Typ Wild werden 1 bis 10 Wilds auf die Walzen gesetzt.',
	...
	'Kraken\'s Wilds is a 5-reel, 3-row video slot with 20 fixed __0__. Winning combinations form from left to right on consecutive reels, starting from the leftmost reel. Only the highest win on each __1__ is __2__.': 'Krakos Wilds ist ein Video-Slot mit 5 Walzen, 3 Reihen und 20 festen Gewinnlinien. Gewinnkombinationen bilden sich von links nach rechts auf aufeinanderfolgenden Walzen, beginnend mit der linken Walze. Nur der höchste Gewinn pro Gewinnlinie wird ausgezahlt.',
	'The theoretical return to player (RTP) of the base game is 96.52%. With Ante Bet active the RTP is 96.46%. The RTP of the Buy Feature is 96.42%. The maximum win is 1,890.60x the total __0__.': 'Die theoretische Auszahlungsquote (RTP) des Hauptspiels beträgt 96,52 %. Mit aktivem Chance X2 beträgt die RTP 96,46 %. Die RTP der Kauffunktion beträgt 96,42 %. Der maximale Gewinn beträgt das 1.890,60-Fache des Gesamteinsatzes im Hauptspiel, das 1.978,00-Fache mit aktivem Chance X2 und das 2.536,70-Fache in der Kauffunktion.',
	...
	'The Wild (Kraken) substitutes for all symbols except the Bonus and Coin symbols. Wild combinations award their own __0__ values.': 'Das Wild (Krakos) ersetzt alle Symbole außer dem Bonus- und dem Münz-Symbol. Wild-Kombinationen gewähren eigene Auszahlungswerte.',
	...
	'Every Free Spin is a Kraken Spin, adding Wild, Coin or paying-symbol copies to the reels before they come to rest. Each Bonus symbol landing during Free Spins awards 1 additional Free Spin, with no limit on retriggers.': 'Jedes Freispiel ist eine Krakos-Drehung und setzt Wilds, Münzen oder Kopien eines Gewinnsymbols auf die Walzen, bevor diese zum Stillstand kommen. Jedes während der Freispiele landende Bonus-Symbol gewährt 1 zusätzliches Freispiel; die Anzahl der erneuten Auslösungen ist unbegrenzt.',
	...
	'BASE GAME': 'HAUPTSPIEL',
	'Bet Replay': 'Einsatz-Wiederholung',
	'Mode': 'Modus',
	'Base Bet': 'Grundeinsatz',
	'Cost Multiplier': 'Kostenmultiplikator',
	'Total Bet Cost': 'Gesamter Einsatz',
	'Payout Multiplier': 'Auszahlungsmultiplikator',
	'Total Win': 'Gesamtgewinn',
	'Start Replay': 'Wiederholung starten',
	'Replay Again': 'Erneut abspielen',
	'This is a replay of a previous bet round. No bets will be placed.': 'Dies ist die Wiederholung einer früheren Runde. Es werden keine Einsätze getätigt.',
	...
	'Any base game spin may trigger a Kraken Spin. When it does, the Kraken places additional symbols on the reels before they come to rest, in one of three forms:': 'Jede Drehung im Hauptspiel kann eine Krakos-Drehung auslösen. In diesem Fall setzt der Krakos zusätzliche Symbole auf die Walzen, bevor diese zum Stillstand kommen — in einer von drei Formen:',
	...
	'Every spin during the Free Spins feature is a Kraken Spin.': 'Während der Freispiele ist jede Drehung eine Krakos-Drehung.',
	// buy-bonus popup + confirmation (betModeMeta)
	'BUY': 'KAUFEN',
	'Instantly triggers 6, 12 or 18 Free Spins. Every Free Spin is a Kraken Spin: the Kraken adds Wilds, Coins or copies of one paying symbol to the reels, and can award a win multiplier for the spin.': 'Löst sofort 6, 12 oder 18 Freispiele aus. Jedes Freispiel ist eine Krakos-Drehung: Der Krakos setzt Wilds, Münzen oder Kopien eines Gewinnsymbols auf die Walzen und kann einen Gewinnmultiplikator für die Drehung vergeben.',
	...
	'ANTE BET': 'CHANCE X2',
	'Ante Bet': 'Chance X2',
	'Double your total bet for double the chance of triggering Kraken Spins and Free Spins. Ante Bet stays active until you turn it off.': 'Verdopple deinen Gesamteinsatz für die doppelte Chance auf Krakos-Drehungen und Freispiele. Chance X2 bleibt aktiv, bis du ihn ausschaltest.',
	'Doubles the chance of Kraken Spins and Free Spins.': 'Verdoppelt die Chance auf Krakos-Drehung und Freispiele.',
	'ACTIVATE': 'AKTIVIEREN',
	'ON': 'AN',
	'OFF': 'AUS',
	...
	'On any Free Spin, the Kraken can also award a win multiplier for that spin. It applies to all wins from that spin, including Coin wins.': 'Bei jedem Freispiel kann der Krakos zusätzlich einen Gewinnmultiplikator für diese Drehung vergeben. Er gilt für alle Gewinne dieser Drehung, einschließlich Münzgewinnen. Der Gewinnmultiplikator kann bis zu x10 betragen.',
	'Ante Bet doubles the total __0__ (x2). It can be turned on or off at any time while the game is idle.': 'Chance X2 verdoppelt den gesamten __0__ (x2). Er kann jederzeit ein- oder ausgeschaltet werden, solange das Spiel im Ruhezustand ist.',
	'While Ante Bet is active, the chance of triggering a Kraken Spin is doubled, and the chance of triggering Free Spins is doubled.': 'Solange Chance X2 aktiv ist, verdoppelt sich die Chance auf eine Krakos-Drehung und die Chance, Freispiele auszulösen.',
	...
	'Ante Bet (toggle) — Turn Ante Bet on or off.': 'Chance X2 (Schalter) — Chance X2 ein- oder ausschalten.',
