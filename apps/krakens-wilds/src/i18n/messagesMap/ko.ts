export default {
	...
	'ANTE BET': '안테 베팅',
	'Ante Bet': '안테 베팅',
	'Double your total bet for double the chance of triggering Kraken Spins and Free Spins. Ante Bet stays active until you turn it off.': '총 베팅을 두 배로 하면 크라켄 스핀과 프리 스핀 발동 확률이 두 배가 됩니다. 안테 베팅은 끌 때까지 유지됩니다.',
	'Doubles the chance of Kraken Spins and Free Spins.': '크라켄 스핀과 프리 스핀 확률을 두 배로 만듭니다.',
	'ACTIVATE': '활성화',
	'ON': '켜짐',
	'OFF': '꺼짐',
