export default {
	...
	'Kraken\'s Wilds is a 5-reel, 3-row video slot with 20 fixed {0}. Wins are evaluated from left to right on each {1}, starting from the leftmost reel. Only symbols on adjacent reels count. The highest win per {1} is {2}.': 'Kraken\'s Wilds est une machine à sous vidéo à 5 rouleaux et 3 rangées avec 20 {0} fixes. Les gains sont évalués de gauche à droite sur chaque {1}, en commençant par le rouleau le plus à gauche. Seuls les symboles sur les rouleaux adjacents comptent. Le gain le plus élevé par {1} est {2}.',
	'Base game: RTP 96.50%. Maximum win: 5,000x total {0}.': 'Jeu de base : RTP 96,50 %. Gain maximum : 5 000x {0} total.',
	'All {0} values are shown as multipliers of the total {1} amount.': 'Toutes les valeurs de {0} sont affichées comme multiplicateurs du montant total de {1}.',
	'The Wild (Kraken) substitutes for all symbols except the Bonus symbol. Wild has its own {0} values.': 'Le Wild (Kraken) remplace tous les symboles sauf le symbole Bonus. Le Wild a ses propres valeurs de {0}.',
	...
	'Only the highest win per {0} is {1}.': 'Seul le gain le plus élevé par {0} est {1}.',
	'Simultaneous wins on different {0} are added together.': 'Les gains simultanés sur différentes {0} sont additionnés.',
	'{0} wins and Bonus wins are added together.': 'Les gains de {0} et les gains Bonus sont additionnés.',
	'Bonus symbols {0} in any position (not limited to {1}).': 'Les symboles Bonus {0} dans n\'importe quelle position (non limités aux {1}).',
	// GameRules — UI guide
	'Spin — Start a spin at the current {0} amount.': 'Tourner — Lancer un tour avec le montant actuel de {0}.',
	...
	'+/− — Increase or decrease the {0} amount.': '+/− — Augmenter ou diminuer le montant de {0}.',
	'Menu (☰) — Open the settings menu.': 'Menu (☰) — Ouvrir le menu des paramètres.',
	'{0} — View symbol {1} values and {2}.': '{0} — Voir les valeurs de {1} des symboles et les {2}.',
