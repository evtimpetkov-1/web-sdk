export default {
	...
	'3 or more Bonus symbols anywhere on the reels trigger Free Spins': '3 eller flere Bonus-symboler hvor som helst på hjulene udløser gratisspins',
	'Each Free Spin guarantees 1 to 10 Random Wilds on the reels': 'Hvert gratisspin garanterer 1 til 10 tilfældige Wilds på hjulene',
	// PayTable — headers
	...
	'Bonus': 'Bonus',
	'Shark': 'Haj',
	'Sea Turtle': 'Havskildpadde',
	'Pearl': 'Perle',
	'Nautilus': 'Nautilus',
	// PayTable — descriptions
	'Substitutes for all symbols except Bonus. During Free Spins, 1, 2, 3, 4, 5, 6, 7, 8, 9, or 10 Random Wilds are placed on the reels each spin.': 'Erstatter alle symboler undtagen Bonus. Under gratisspins placeres 1, 2, 3, 4, 5, 6, 7, 8, 9 eller 10 tilfældige Wilds på hjulene ved hvert spin.',
