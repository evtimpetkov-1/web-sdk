export default {
	...
	'Kraken\'s Wilds is a 5-reel, 3-row video slot with 20 fixed __0__. Winning combinations form from left to right on consecutive reels, starting from the leftmost reel. Only the highest win on each __1__ is __2__.': 'Krakos Wilds是一款5轴3行的视频老虎机，拥有20条固定赔付线。中奖组合从最左侧转轴开始，在连续转轴上从左到右形成。每条赔付线仅支付最高奖金。',
	'The theoretical return to player (RTP) of the base game is 96.52%. With Ante Bet active the RTP is 96.46%. The RTP of the Buy Feature is 96.42%. The maximum win is 1,890.60x the total __0__.': '基础游戏的理论玩家回报率（RTP）为96.52%。启用机会 X2时RTP为96.46%。购买功能的RTP为96.42%。最大赢额为：基础游戏中总投注的1,890.60倍，启用机会 X2时为1,978.00倍，购买功能中为2,536.70倍。',
	...
	'The Free Spins feature can be bought directly for __0__ the total __1__. A purchased feature plays exactly as one triggered by Bonus symbols, and the return to player is the same.': '免费旋转功能可以直接以总__1__的__0__购买。购买的功能与由奖励符号触发的功能完全相同。',
	...
	'Mode': '模式',
	'Base Bet': '基础投注',
	'Cost Multiplier': '费用倍数',
	'Total Bet Cost': '总投注费用',
	'Payout Multiplier': '赔付倍数',
	'Total Win': '总赢额',
	'Start Replay': '开始回放',
	'Replay Again': '再次回放',
	'This is a replay of a previous bet round. No bets will be placed.': '这是先前一局投注的回放。不会进行任何投注。',
	...
	'ANTE BET': '机会 X2',
	'Ante Bet': '机会 X2',
	'Double your total bet for double the chance of triggering Kraken Spins and Free Spins. Ante Bet stays active until you turn it off.': '将总投注翻倍，即可使触发海怪旋转和免费旋转的几率翻倍。机会 X2将保持启用，直到您将其关闭。',
	...
	'Ante Bet doubles the total __0__ (x2). It can be turned on or off at any time while the game is idle.': '机会 X2使总__0__翻倍（x2）。游戏处于空闲状态时可随时开启或关闭。',
	'While Ante Bet is active, the chance of triggering a Kraken Spin is doubled, and the chance of triggering Free Spins is doubled.': '机会 X2启用时，触发海怪旋转的几率翻倍，触发免费旋转的几率也翻倍。',
	'All __0__ values remain multiples of the base (non-doubled) __1__ amount.': '所有__0__值仍为基础（未翻倍）__1__金额的倍数。',
	'Ante Bet (toggle) — Turn Ante Bet on or off.': '机会 X2（开关）— 开启或关闭机会 X2。',
