export default {
	...
	'Any base game spin may trigger a Kraken Spin. When it does, the Kraken places additional symbols on the reels before they come to rest, in one of three forms:': 'يمكن لأي دورة في اللعبة الأساسية أن تُطلق دورة الكراكن. عندها يضع Kraken رموزًا إضافية على البكرات قبل توقفها، بإحدى ثلاث صور:',
	...
	'Buy 6, 12 or 18 Free Spins for __0__x your total bet?': 'هل تريد شراء 6 أو 12 أو 18 دورة مجانية مقابل __0__x من إجمالي رهانك؟',
	...
	'Doubles the chance of Kraken Spins and Free Spins.': 'يضاعف فرصة دورات الكراكن والدورات المجانية.',
	'ACTIVATE': 'تفعيل',
	'ON': 'تشغيل',
	'OFF': 'إيقاف',
