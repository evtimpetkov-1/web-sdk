export default {
	...
	'Kraken\'s Wilds is a 5-reel, 3-row video slot with 20 fixed __0__. Wins are evaluated from left to right on each __1__, starting from the leftmost reel. Only symbols on adjacent reels count. The highest win per __1__ is __2__.': 'Kraken\'s Wilds هي لعبة سلوت فيديو بـ 5 بكرات و3 صفوف مع 20 خطوط دفع ثابت. يتم تقييم الأرباح من اليسار إلى اليمين على كل خط دفع، بدءًا من البكرة اليسرى. تُحتسب فقط الرموز على البكرات المتجاورة. أعلى ربح لكل خط دفع هو مدفوع.',
	'Base game: RTP 96.50%. Maximum win: 5,000x total __0__.': 'اللعبة الأساسية: RTP 96.50%. الحد الأقصى للربح: 5,000x إجمالي رهان.',
	'All __0__ values are shown as multipliers of the total __1__ amount.': 'جميع قيم دفع معروضة كمضاعفات لإجمالي مبلغ رهان.',
	'The Wild (Kraken) substitutes for all symbols except the Bonus symbol. Wild has its own __0__ values.': 'يحل Wild (Kraken) محل جميع الرموز باستثناء رمز Bonus. يمتلك Wild قيم دفع خاصة به.',
	...
	'Bonus symbols __0__ in any position (not limited to __1__).': 'رموز Bonus دفع في أي موضع (غير مقيدة بـ خطوط دفع).',
	// GameRules — UI guide
	'Spin — Start a spin at the current __0__ amount.': 'دوران — ابدأ دورة بمبلغ رهان الحالي.',
	...
	'+/− — Increase or decrease the __0__ amount.': '+/− — زيادة أو تقليل مبلغ رهان.',
	'Menu (☰) — Open the settings menu.': 'القائمة (☰) — افتح قائمة الإعدادات.',
	'__0__ — View symbol __1__ values and __2__.': 'جدول الدفع — عرض قيم دفع للرموز وخطوط دفع.',
