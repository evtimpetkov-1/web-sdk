export default {
	...
	'Substitutes for all symbols except Bonus and Coin. A Wild Kraken Spin adds 1 to 10 Wild symbols to the reels.': 'يحل محل جميع الرموز باستثناء Bonus والعملة. في دورة كراكوس من نوع Wild، توضع من 1 إلى 10 رموز Wild على البكرات.',
	...
	'Kraken\'s Wilds is a 5-reel, 3-row video slot with 20 fixed __0__. Winning combinations form from left to right on consecutive reels, starting from the leftmost reel. Only the highest win on each __1__ is __2__.': 'Krakos Wilds هي لعبة سلوت فيديو من 5 بكرات و3 صفوف مع 20 خط دفع ثابتًا. تتكوّن التوليفات الرابحة من اليسار إلى اليمين على بكرات متتالية، بدءًا من البكرة اليسرى. يُدفع أعلى ربح فقط على كل خط دفع.',
	'The theoretical return to player (RTP) of the base game is 96.52%. With Ante Bet active the RTP is 96.46%. The RTP of the Buy Feature is 96.42%. The maximum win is 1,890.60x the total __0__.': 'العائد النظري للاعب (RTP) في اللعبة الأساسية هو 96.52%. عند تفعيل الفرصة X2 يكون RTP هو 96.46%. عائد شراء الميزة هو 96.42%. الحد الأقصى للربح هو 1,890.60x من إجمالي الرهان في اللعبة الأساسية، و1,978.00x عند تفعيل الفرصة X2، و2,536.70x في شراء الميزة.',
	'All __0__ values are shown as multipliers of the total __1__ amount.': 'تُعرض جميع قيم الدفع كمضاعفات لإجمالي مبلغ الرهان.',
	'The Wild (Kraken) substitutes for all symbols except the Bonus and Coin symbols. Wild combinations award their own __0__ values.': 'يحل رمز Wild (كراكوس) محل جميع الرموز باستثناء رمزي Bonus والعملة. تمنح توليفات Wild قيم دفع خاصة بها.',
	...
	'Replay Again': 'إعادة مرة أخرى',
	'This is a replay of a previous bet round. No bets will be placed.': 'هذه إعادة لجولة رهان سابقة. لن يتم وضع أي رهانات.',
	...
	'Any base game spin may trigger a Kraken Spin. When it does, the Kraken places additional symbols on the reels before they come to rest, in one of three forms:': 'يمكن لأي دورة في اللعبة الأساسية أن تُطلق دورة كراكوس. عندها يضع كراكوس رموزًا إضافية على البكرات قبل توقفها، بإحدى ثلاث صور:',
	...
	'Every spin during the Free Spins feature is a Kraken Spin.': 'خلال الدورات المجانية، كل دورة هي دورة كراكوس.',
	// buy-bonus popup + confirmation (betModeMeta)
	'BUY': 'شراء',
	'Instantly triggers 6, 12 or 18 Free Spins. Every Free Spin is a Kraken Spin: the Kraken adds Wilds, Coins or copies of one paying symbol to the reels, and can award a win multiplier for the spin.': 'يُفعّل فورًا 6 أو 12 أو 18 دورة مجانية. كل دورة مجانية هي دورة كراكوس: يضيف كراكوس رموز Wild أو عملات أو نسخًا من رمز دافع واحد على البكرات، وقد يمنح مضاعف ربح للدورة.',
	'Buy the Free Spins Feature for __0__x your total bet. The Bonus trigger spin awards 6, 12 or 18 Free Spins.': 'اشترِ ميزة الدورات المجانية مقابل __0__x من إجمالي رهانك.\nتمنح دورة التفعيل 6 أو 12 أو 18 دورة مجانية.',
	...
	'ANTE BET': 'الفرصة X2',
	'Ante Bet': 'الفرصة X2',
	'Double your total bet for double the chance of triggering Kraken Spins and Free Spins. Ante Bet stays active until you turn it off.': 'ضاعف إجمالي رهانك مقابل مضاعفة فرصة تفعيل دورات كراكوس والدورات المجانية. يبقى الفرصة X2 مفعلاً حتى توقفه.',
	'Doubles the chance of Kraken Spins and Free Spins.': 'يضاعف فرصة دورة كراكوس والدورات المجانية.',
	'ACTIVATE': 'تفعيل',
	'ON': 'تشغيل',
	'OFF': 'إيقاف',
	...
	'Ante Bet (toggle) — Turn Ante Bet on or off.': 'الفرصة X2 (مفتاح) — تشغيل الفرصة X2 أو إيقافه.',
	// FS intro card (v4, 2026-08-28) — badge captions
	'EVERY SPIN IS A KRAKEN SPIN': 'كل دورة هي دورة كراكوس',
	'MULTIPLIERS UP TO x10': 'مضاعفات حتى x10',
	'EACH BONUS AWARDS +1 SPIN': 'كل رمز Bonus يمنح دورة إضافية',
