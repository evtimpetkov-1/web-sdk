export default {
	...
	'ANTE BET': 'アンティベット',
	'Ante Bet': 'アンティベット',
	'Double your total bet for double the chance of triggering Kraken Spins and Free Spins. Ante Bet stays active until you turn it off.': '合計ベットを2倍にすると、クラーケンスピンとフリースピンの発動確率が2倍になります。アンティベットはオフにするまで有効です。',
	'Doubles the chance of Kraken Spins and Free Spins.': 'クラーケンスピンとフリースピンの確率を2倍にします。',
	'ACTIVATE': '有効にする',
	'ON': 'オン',
	'OFF': 'オフ',
