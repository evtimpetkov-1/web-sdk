...
export default {
	...
	'TOTAL WIN': 'TOTAL WIN',
	// LoadingScreen
	'KRAKEN SPIN': 'KRAKOS SPIN',
	'Land 3, 4 or 5 Bonus symbols anywhere on the reels to win 6, 12 or 18 Free Spins. Every Free Spin is a Kraken Spin.': 'Land 3, 4 or 5 Bonus symbols anywhere on the reels to win 6, 12 or 18 Free Spins. Every Free Spin is a Krakos Spin.',
	'The Kraken can strike any spin, adding Wilds, Coins or extra paying symbols to the reels.': 'The Krakos can strike any spin, adding Wilds, Coins or extra paying symbols to the reels.',
	// PayTable — headers
	...
	'Substitutes for all symbols except Bonus and Coin. A Wild Kraken Spin adds 1 to 10 Wild symbols to the reels.': 'Substitutes for all symbols except Bonus and Coin. A Wild Krakos Spin adds up to 10 Wild symbols to the reels.',
	...
	'Kraken\'s Wilds is a 5-reel, 3-row video slot with 20 fixed __0__. Winning combinations form from left to right on consecutive reels, starting from the leftmost reel. Only the highest win on each __1__ is __2__.': 'Krakos Wilds is a 5-reel, 3-row video slot with 20 fixed __0__. Winning combinations form from left to right on consecutive reels, starting from the leftmost reel. Only the highest win on each __1__ is __2__.',
	'The theoretical return to player (RTP) of the base game is 96.52%. With Ante Bet active the RTP is 96.46%. The RTP of the Buy Feature is 96.42%. The maximum win is 1,890.60x the total __0__.': 'The theoretical return to player (RTP) of the base game is 96.52%. With Chance X2 active the RTP is 96.46%. The RTP of the Buy Feature is 96.42%. The maximum win is 1,890.60x the total __0__ in the base game, 1,978.00x with Chance X2 active and 2,536.70x in the Buy Feature.',
	...
	'The Wild (Kraken) substitutes for all symbols except the Bonus and Coin symbols. Wild combinations award their own __0__ values.': 'The Wild (Krakos) substitutes for all symbols except the Bonus and Coin symbols. Wild combinations award their own __0__ values.',
	...
	'Every Free Spin is a Kraken Spin, adding Wild, Coin or paying-symbol copies to the reels before they come to rest. Each Bonus symbol landing during Free Spins awards 1 additional Free Spin, with no limit on retriggers.': 'Every Free Spin is a Krakos Spin, adding Wild, Coin or paying-symbol copies to the reels before they come to rest. Each Bonus symbol landing during Free Spins awards 1 additional Free Spin, with no limit on retriggers.',
	'The Free Spins feature can be bought directly for __0__ the total __1__. A purchased feature plays exactly as one triggered by Bonus symbols, and the return to player is the same.': 'The Free Spins feature can be bought directly for __0__ the total __1__. A purchased feature plays exactly as one triggered by Bonus symbols.',
	...
	'This is a replay of a previous bet round. No bets will be placed.': 'This is a replay of a previous bet round. No bets will be placed.',
	...
	'Any base game spin may trigger a Kraken Spin. When it does, the Kraken places additional symbols on the reels before they come to rest, in one of three forms:': 'Any base game spin may trigger a Krakos Spin. When it does, the Krakos places additional symbols on the reels before they come to rest, in one of three forms:',
	...
	'ANTE BET': 'CHANCE X2',
	'Ante Bet': 'Chance X2',
	'Double your total bet for double the chance of triggering Kraken Spins and Free Spins. Ante Bet stays active until you turn it off.': 'Double your total bet for double the chance of triggering Krakos Spins and Free Spins. Chance X2 stays active until you turn it off.',
	'Doubles the chance of Kraken Spins and Free Spins.': 'Doubles the chance of Krakos Spin and Free Spins.',
	'ACTIVATE': 'ACTIVATE',
	'ON': 'ON',
	'OFF': 'OFF',
	...
	'On any Free Spin, the Kraken can also award a win multiplier for that spin. It applies to all wins from that spin, including Coin wins.': 'On any Free Spin, the Krakos can also award a win multiplier for that spin. It applies to all wins from that spin, including Coin wins. The win multiplier can be up to x10.',
	'Ante Bet doubles the total __0__ (x2). It can be turned on or off at any time while the game is idle.': 'Chance X2 doubles the total __0__ (x2). It can be turned on or off at any time while the game is idle.',
	'While Ante Bet is active, the chance of triggering a Kraken Spin is doubled, and the chance of triggering Free Spins is doubled.': 'While Chance X2 is active, the chance of triggering a Krakos Spin is doubled, and the chance of triggering Free Spins is doubled.',
	...
	'Ante Bet (toggle) — Turn Ante Bet on or off.': 'Chance X2 (toggle) — Turn Chance X2 on or off.',
	// FS intro card (v4, 2026-08-28) — badge captions
	'EVERY SPIN IS A KRAKEN SPIN': 'EVERY SPIN IS A KRAKOS SPIN',
