...
export const i18nDerived = {
	...
	loadingKrakenDesc: () => t('The Kraken can strike any spin adding up to 10 Wilds or Coins on the reels. Every Free Spin is a Kraken Spin.'),
	// PayTable — headers
	...
	krakenSpinDesc: () => t('Any base game spin may trigger a Kraken Spin. When it does, the Kraken places additional symbols on the reels before they come to rest, in one of two forms:'),
	...
	fsDesc: () => t('Every Free Spin is a Kraken Spin, placing either Wild or Coin symbols on the reels before they come to rest. Each Bonus symbol landing during Free Spins awards 1 additional Free Spin, with no limit on retriggers.'),
