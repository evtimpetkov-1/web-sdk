...
export const i18nDerived = {
	...
	// LoadingScreen
	specialSpin: () => t('SPECIAL SPIN'),
	loadingFsDesc: () => t('Land 3, 4 or 5 Bonus symbols anywhere on the reels to win 6, 12 or 18 Free Spins'),
	loadingSpecialDesc: () => t('The Kraken can strike on any spin, adding up to 10 Wilds or up to 10 Coins to the reels. Every Free Spin is a Special Spin.'),
	// PayTable — headers
	...
	wildDesc: () => t('Substitutes for all symbols except Bonus and Coin. A Wild Special Spin adds 1 to 10 Wild symbols to the reels.'),
	...
	specialSpinHeader: () => t('Special Spin'),
	...
	specialSpinDesc: () => t('Any base game spin may trigger a Special Spin. When it does, the Kraken places additional symbols on the reels before they come to rest, in one of two forms:'),
	specialSpinWild: () => t('Wild — 1 to 10 Wild symbols are added to the reels. All __0__ are evaluated once they are in place, and any win is __1__.'),
	specialSpinCoin: () => t('Coin — 1 to 10 Coin symbols are added to the reels. __0__ are evaluated first; the values of all Coin symbols are then totalled and awarded in addition.'),
	specialSpinFs: () => t('Every spin during the Free Spins feature is a Special Spin.'),
	...
	fsDesc: () => t('Every Free Spin is a Special Spin, placing either Wild or Coin symbols on the reels before they come to rest. Each Bonus symbol landing during Free Spins awards 1 additional Free Spin, with no limit on retriggers.'),
